...
{
    bg00 = LoadGraph("Data/Stage_02/road1 light.png");
    bg01 = LoadGraph("Data/Stage_02/road2 light.png");

    for (int i = 10; i <= 13; i++) {
        char path[64];
        sprintf_s(path, "Data/Stage_02/bg%d.png", i);
        eventBG.push_back(LoadGraph(path));
    }

    enemyGraph = LoadGraph("Data/Stage_02/enemy00.png");
    stepSE = LoadSoundMem("Data/Stage_02/step.mp3");
}
